    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-Rishsky py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md bg-RishlightSky" href={`/list/lessons?classId=4B`}>
              Student&apos;s Lessons
            </Link>
            <Link className="p-3 rounded-md bg-RishpurpleLight" href={`/list/teachers?classId=4B`}>
              Student&apos;s Teachers
            </Link>
            <Link className="p-3 rounded-md bg-Rishyellow" href={`/list/results?studentId=${params.id}`}>
              Student&apos;s Results
            </Link>
            <Link className="p-3 rounded-md bg-Rishsky" href={`/list/attendance?studentId=${params.id}`}>
              Student&apos;s Attendance
            </Link>
            <Link className="p-3 rounded-md bg-Rishpurple" href={`/list/exams?classId=4B`}>
              Student&apos;s Exams
            </Link>
          </div>
        </div>
