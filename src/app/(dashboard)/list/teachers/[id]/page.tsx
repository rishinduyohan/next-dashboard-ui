      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white dark:bg-slate-900 p-4 rounded-md border border-gray-100 dark:border-slate-800 shadow-sm">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500 dark:text-slate-300">
            <Link
              className="p-3 rounded-md bg-RishlightSky dark:bg-sky-950 dark:text-sky-200"
              href={`/list/classes?supervisorId=${"teacher2"}`}
            >
              Teacher&apos;s Classes
            </Link>
            <Link
              className="p-3 rounded-md bg-RishpurpleLight dark:bg-purple-950 dark:text-purple-200"
              href={`/list/students?teacherId=${"teacher2"}`}
            >
              Teacher&apos;s Students
            </Link>
            <Link
              className="p-3 rounded-md bg-RishyellowLight dark:bg-yellow-950 dark:text-yellow-200"
              href={`/list/lessons?classId=${"class1"}`}
            >
              Teacher&apos;s Lessons
            </Link>
            <Link
              className="p-3 rounded-md bg-Rishsky dark:bg-sky-900 dark:text-sky-100"
              href={`/list/exams?teacherId=${"teacher2"}`}
            >
              Teacher&apos;s Exams
            </Link>
            <Link
              className="p-3 rounded-md bg-Rishpurple dark:bg-purple-900 dark:text-purple-100"
