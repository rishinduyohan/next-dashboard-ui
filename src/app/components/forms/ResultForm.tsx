    ...
    <form className="flex flex-col gap-8 text-gray-800 dark:text-slate-100" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          <label className="text-xs text-gray-500 dark:text-slate-400">Score</label>
          <input type="number" {...register("score")} className="ring-[1.5px] ring-gray-300 dark:ring-slate-700 bg-transparent dark:bg-slate-800 p-2 rounded-md text-sm w-full outline-none focus:ring-blue-400" />
        </div>
        <div className="flex flex-col gap-2 w-full md:w-1/4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          <select {...register("type")} className="ring-[1.5px] ring-gray-300 dark:ring-slate-700 bg-transparent dark:bg-slate-800 p-2 rounded-md text-sm w-full outline-none focus:ring-blue-400">
